...
<div id="id03" class="modal">
	<form id="settingsForm" class="modal-content animate" action="{{ url('/user/edit/'.Auth::user()->id) }}" method = "POST" >
		{{ csrf_field() }}
		...
		<div class="logcontainer">
			...
			<input type="text" placeholder="Current Username" name="newUsername" id="newUsername" value="{{ Auth::user()->name }}" required>
...
<div id="id08" class="modal">
	<form id="settingsForm" class="modal-content animate" action="{{ url('/user/edit/'.$user->id) }}" method = "POST" >
		...
		<div class="logcontainer">
			<label><b>Username</b></label>
			<input type="text" placeholder="Current Username" name="newUsername" id="newUsername" value="{{$user->name0 }}" required>
			<label><b>Old Password</b></label>
			<input type="text" placeholder="Enter Current Password" name="oldPassword">
			<label><b>New Password</b></label>
			<input type="password" placeholder="Enter New Password" name="newPassword" id="newPassword">
		...
		<table class="table table-hover table-striped my-table">
			...
			<tbody>
				...
				<tr>
					...
					@if(!Auth::guest() and (Auth::user()->id == $user->id or Auth::user()->admin))
